...
namespace app\modules\auth\v2\domain\entities;
...
abstract class AbstractAccessToken extends ActiveRecord
{
    ...
    {
        return [
//            [['user__id', 'auth_code', 'access_token'], 'required', 'on' => self::SCENARIO_INITIALIZE],
//            [['refresh_token', 'access_token'], 'required', 'on' => self::SCENARIO_AUTHENTICATE],
//            [['access_token'], 'required', 'on' => self::SCENARIO_REFRESH_TOKEN],
            [['user__id'], 'integer'],
            [['auth_code'], 'integer'],
            [['created_at'], 'safe'],
